#Аникина Дарья, ПАЭ 130, Вариант 1
...
#Проверка и выбор рабочей директории
getwd()
...
glimpse(eddypro)
#Изменяем специальные символы в названии стобцов на допустимые для переменных названия
